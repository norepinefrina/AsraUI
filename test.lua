...
function TabElements:Box(Title, Cally)
local Box = Instance.new("TextButton")
Box.TextXAlignment = 0
Box.Name = "Box"
Box.TextColor3 = Color3.fromHex("7A7A84")
Box.Text = Title
Box.Font = 9
Box.Size = UDim2.new(1, 0, 0, 25)
Box.TextScaled = true
Box.BackgroundColor3 = Color3.fromHex("1D1D27")
Box.BorderSizePixel = 0
Box.Parent = Tab
Instance.new("UICorner", Box).CornerRadius = UDim.new(0, 8)
local BoxImg = Instance.new("TextBox")
BoxImg.Position = UDim2.new(1, -30, 0, 0)
BoxImg.Size = UDim2.new(0, 30, 0, 30)
BoxImg.Parent = Box
Instance.new("UICorner", BoxImg).CornerRadius = UDim.new(0, 8)

BoxImg.FocusLost:Connect(function()
if BoxImg.Text ~= "" then
pcall(Cally, BoxImg.Text)
end
end)
end
