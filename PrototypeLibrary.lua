...
Back.Name = "Back"
Back.BackgroundColor3 = Color3.fromHex("000000")
...
X.Font = 9
X.TextColor3 = Color3.fromHex("ffffff")
...
TitleUI.Text = Title
TitleUI.TextColor3 = Color3.fromHex("ffffff")
TitleUI.Font = 9
...
TabsOpenContainer.BackgroundColor3 = Color3.fromHex("1f1f1f")
...
TabsContainer.BackgroundColor3 = Color3.fromHex("1f1f1f")
...
OpenTab.TextColor3 = Color3.fromHex("ffffff")
OpenTab.Text = Title
OpenTab.Size = UDim2.new(1, 0, 0, 30)
OpenTab.TextScaled = true
OpenTab.BackgroundColor3 = Color3.fromHex("2e2e2e")
OpenTab.Font = 9
...
Info.Name = "Info"
Info.TextColor3 = Color3.fromHex("ffffff")
Info.Parent = Tab
end
...
Button.BackgroundColor3 = Color3.fromHex("2e2e2e")
...
Tog.BackgroundColor3 = Color3.fromHex("2e2e2e")
Tog.TextXAlignment = 0
Tog.TextColor3 = Color3.fromHex("ffffff")
Tog.Text = Title
Tog.Font = 9
Tog.TextScaled = true
Tog.Parent = Tab
